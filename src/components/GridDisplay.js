...
const GridDisplay = ({children, content, small, sectionLabel}) => {
  return (
    <div className='container mx-auto flex flex-col gap-10'>
        <div className='grid-header flex flex-col items-center gap-7'>
            <p className='small text-xl font-bold text-white bg-yellow-500 px-5 py-2'>{small}</p>
            <h3 className='large text-5xl font-bold'>{sectionLabel}</h3>
        </div>
    ...
    return (
        <div className='flex flex-col items-center gap-3 sm:shadow-lg py-5 px-10 sm:px-5'>
            ...
            <div className='w-full flex flex-row justify-between gap-5'>
                <span className='text-md font-light'>starting from <span className='font-bold'>${bike.basePrice} /day</span></span>
